...
def custom_heuristic(state):
    # celule nu sunt in pozitia corecta
    misplaced = 0
...
# distanta intre stare finala si stare curenta
    ...
    while not pq.empty():
        ...
        for neighbor, _ in generate_successor_states(state, -1):
            if neighbor not in path:
                ...
                pq.put((heuristic_func(neighbor), new_path))
